...
сервера vsftpd и openssh и реализация FUSE S3 файловой системы [AkaveFS](https://github.com/akave-ai/akavefs).
...
AkaveFS использует кэш, в котором накапливаются данные перед отправкой в бакет, что
